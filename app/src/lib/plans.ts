...
import casaV from "../../../fixtures/casa-v.json?raw";
...
export const EXAMPLES: Example[] = [
  ...
  { id: "casa-v", name: "Casa em V", shows: "one open living-kitchen bar with a glass wall onto a decked pool, two wings splayed 60° off it and a double garage on the east flank: every wing wall is angled", source: casaV },
